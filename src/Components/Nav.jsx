  ...
  return (
   ...
   <li>Admin</li>
      ...
      <div className="flex gap-4 ">
        <button className="px-2 py-2 border border-amber-800 text-amber-800 hover:bg-amber-900 hover:text-white rounded-xl flex items-center justify-between gap-1 transition-all duration-300"> <FaSignInAlt size={18}/>  Login</button>
        <button className="px-2 py-2 bg-amber-700 text-white hover:bg-green-700 rounded-xl flex items-center justify-between gap-1 transition-all duration-300"><FaUser size={14} />  Registre</button>
      </div>
    </div>
