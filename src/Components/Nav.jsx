...
<li><Link to={'/vet'} >Vets</Link></li>
  ...
  <li><Link to={'/reservation'} >Reservation</Link></li>
      ...
      <div className="flex gap-4 ">
        ...
        <button className="px-2 py-2 bg-amber-700 text-white hover:bg-green-700 rounded-xl flex items-center justify-between gap-1 transition-all duration-300 hover:scale-105"><FaUser size={14} />  Registre</button>
      </div>
    </div>
