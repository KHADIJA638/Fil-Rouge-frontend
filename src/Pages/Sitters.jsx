...
export default function Sitters() {
  ...
  return (
    <div>
      ...
      <button onClick={() => navigate(`/vet/${sittercard.id}`)} className="border border-amber-950 rounded-xl text-white bg-amber-800 hover:bg-red-950 transition-all duration-300 hover:scale-105 mt-2 p-2"> 
        View details
      </button>
